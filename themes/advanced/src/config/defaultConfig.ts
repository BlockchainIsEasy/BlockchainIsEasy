...
const config: SiteConfig = {
  ...
  website: {
    title: "Blockchain Is Easy", // Homepage title
    titleShort: "BlockchainIsEasy", // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation
    name: "Blockchain Is Easy", // Website name used for homescreen (PWA) and SEO
